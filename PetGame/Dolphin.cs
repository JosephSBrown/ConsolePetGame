...
namespace PetGame
{
    //Start the Doplhin Class
    class Dolphin : Pet     //Inherit from the Pet Class
    {
        private static object ConsoleLock = new object();   //Object to make Thread Lock

        //Dolphin Properties Overridden from Default inherited from Pet
        public Dolphin()
        {
            Type = "Dolphin";       //Set Pet Type as Dolphin
