...
namespace PetGame
{
    //Start Class for Axolotl
    class Axolotl : Pet     //Inherit the Pet Class
    {

        private static object ConsoleLock = new object();

        //Axolotl Properties Overridden from Default inherited from Pet
        public Axolotl()
        {
            Type = "Axolotl";       //Set Pet Type as Axolotl
